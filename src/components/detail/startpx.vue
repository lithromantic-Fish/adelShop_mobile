<style type="text/css">
    * {
    ...
    .tab-tite_startPx_pirce {
        color: black!important;
        padding-bottom: .1rem;
        box-sizing: border-box;
    }
    .tab-tite_startPx_evalute {
        color: red;
        padding-bottom: .1rem;
        box-sizing: border-box;
...
<template>
    <div>
         <headersec tabname="明星产品" ref="noback" @nodeEvent="heiheihei"></headersec>
        ...
        <div class="flex-between flex-align-center">
            <div class="wapr">
                ...
                <div class="my_wrap">
                    <div class="tab-item">
                        <router-link to='./startData'>
                            <p class="tab-tite_startPx_pirce">价格</p>
                        </router-link>
                    </div>
                    <div class="tab-item">
                        <router-link to='./startpx'>
                            <p class="tab-tite_startPx_evalute ">评论最多</p>
                        </router-link>
                    </div>
                </div>
                    <!--展示上拉加载的数据列表-->
        ...
        methods: {
            ...
            upCallback: function(page) {
                ...
                function getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
                    self.$http
                        .post("/myapi/adel-shop/app/starGoods.htm?orderBy=evaluates_size&currentPage=" + page.num)
                        .then(function(res) {
