            ...
            <div class="my_wrap1">
                <div class="tab-item">
                    <!-- <router-link to='./SearchReslut'> -->
                     <router-link :to="{path: './SearchReslut', query: {pxText: changeText}}">
                        <p class="tab-tite13">价格</p>
                    </router-link>
                </div>
                <div class="tab-item">
                    <router-link to='./SearchReslutpx'>
...
<script>
    ...
    export default {
        ...
        methods: {
            getProductList() {
                console.log('this.$route.query.titleText', this.$route.query.changeText);
                this.changeText  = this.$route.query.changeText
                const that = this
                 this.$http
                    .get("/myapi/adel-shop/app/search.htm?orderBy=evaluates_size&keyword=" + that.changeText)
                    .then(function(res) {
