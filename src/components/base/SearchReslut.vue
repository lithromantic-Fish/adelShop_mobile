<template>
    <div class="ALl">
        <SearchBar></SearchBar>
        <headersec :tabname="changeText" ref="noback"></headersec>
        <div>
            <div class="my_wrap1">
                <div class="tab-item">
                ...
                <div class="tab-item">
                    ...
                    <router-link :to="{path: 'SearchReslutpx', query: {changeText: changeText}}">
                        <p class="tab-tite16">评论最多</p>
                    </router-link>
                </div>
            </div>
            <div style="background-color:#eee;">
                <div class="wrap_goods" v-for="item in  productList">
                    <div class="items">
...
<script>
    ...
    export default {
        ...
        methods: {
            getProductList() {
                console.log('this.$route.query.searchList', this.$route.query.input_text);
                const that = this
                 this.$http
                    .get("/myapi/adel-shop/app/search.htm?orderBy=goods_current_price&keyword=" + that.changeText)
                    .then(function(res) {
